...
//import Shipping from '../../../components/admin/operation/order/order/Shipping';
                            ...
                            <div className="product-status-wrap">
                                ...
                                <Tabs selectedIndex={[-1, 1, 2, 3, 6, 7, 8, 5, 9, 4].findIndex((v) => v === order_status)} onSelect={(index) => { setStatus([-1, 1, 2, 3, 6, 7, 8, 5, 9, 4][index]), setPaginate({ _page: 1, _pagesize: 20 }) }} >
                                    <TabList className="d-flex justify-content-between border-bottom-0 mb-3 overflow-auto text-nowrap">
                                        ...
                                        <Tab className="border-0 pb-2 px-1 text-center cursor" aria-id="unpaid">
                                            <a>Unpaid ({status_count[1]})</a>
                                        </Tab>

                                        <Tab className="border-0 pb-2 px-1 text-center cursor" id="accept">
                                ...
                                <div className="d-flex align-content-center justify-content-between mb-3">
                                    ...
                                    <div className="col-md-6 col-12 d-flex align-content-center justify-content-md-end">
                                        {order_status === 3 && <a className="btn btn-success btn-sm" href={`${process.env.NEXT_PUBLIC_BASEPATH || ""}/api/store/order/shipping/download?access_token=${Api.token}`}>Packing List</a>}
                                        &emsp;
                                        {order_status === 3 &&
                                            <>
                                                                ...
                                                                return <tr key={index}>
                                                                    ...
                                                                    <td>{
                                                                        order.items.map((item, i) => <>
                                                                            {`${i + 1}. ${item.name} x${item.quantity}`}<br />
                                                                        </>)
                                                                    }</td>
                                                                    <td>
                                                                        {{
                                                                    ...
                                                                    <td>
                                                                        {{
                                                                            0: <a
                                                                                href={basepath(`/admin/operation/order/${order.id}`)}
