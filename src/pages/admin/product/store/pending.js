...
export default function productList() {
    ...
    const getProductList = async () => {
        try {
            let products = await Api.listPendingProducts(product_status, paginate, _search);
            products.results.forEach(product => {
                product.checked = false
            });
    ...
    // 
    const onApprove = async (product_id) => {
        try {
            if (await Api.approveProduct(product_id)) {
    ...
    const onBulkApprove = async () => {
        try {
            ...
            await Api.bulkApproveProduct(product_ids);
            toast.success("Product Approved", {
                autoClose: 1000
            });
            await getProductList();
                            ...
                            <div className="product-status-wrap">
                                ...
                                <div className="row mb-3">
                                    <div className="col-md-6 col-12 d-flex align-content-center">
                                        <h4 className="mb-3 mb-md-0 fs-6">Pending Proposed Product List</h4>
                                    </div>
                        ...
                        <div className="col-lg-12 col-md-12 col-sm-12 col-12">
                            <div className="px-3 d-flex justify-content-between">
                                ...
                                <div className="text-end" id="foooter">
                                    ...
                                    <button type="button" className="btn btn-sm btn-primary ms-2" onClick={onBulkApprove}>Approve</button>
