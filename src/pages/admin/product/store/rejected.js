...
export default function productList() {
    ...
    const getProductList = async () => {
        try {
            let products = await Api.listRejectedProducts(product_status, paginate, _search);
            products.results.forEach(product => {
                product.checked = false
            });
                        ...
                        <div className="col-lg-12 col-md-12 col-sm-12 col-12">
                            <div className="px-3 d-flex justify-content-between">
                                ...
                                <div className="text-end" id="foooter">
                                    ...
                                    <button type="button" className="btn btn-sm btn-success ms-2" onClick={onBulkApprove}>Approve</button>
                                </div>
                            </div>
                        </div>
                    </div>
