...
export default function verify() {
    const onReverify = async () => {
        try {
            ...
            toast.success("New Email Verification Sent", {
                autoClose: 5000,
            ...
            <div className="row mx-0" style={{ minHeight: '100vh' }}>
                ...
                <div className="col-md-8 col-12 p-5 d-flex flex-column align-items-center position-relative">
                    <div style={{ maxWidth: 700, paddingTop: '15%' }}>
                        ...
                        <p className="mb-4">An email verification link has been sent to your inbox, please click to verify your email</p>
                        {/* <button className="btn btn-primary mt-4" onClick={onReverify} >Click to Resend</button> */}
                        <div className="row">
